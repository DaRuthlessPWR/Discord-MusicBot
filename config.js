module.exports = {
	...
	adminId: "1154494919038222448", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.gg/grapes", //- Support Server Link
	Issues: "https://github.com/DaRuthlessPWR/Discord-MusicBot/issues", //- Bug Report Link
	...
	nodes: [
		{
			...
			host: "lavalink.techpoint.world", //- The host name or IP of the lavalink server.
			port: 80, // The port that lavalink is listening to. This must be a number!
			password: "techpoint", //- The password of the lavalink server.
